//! in src/fs/disk_handler.rs
//!
use crate::fs::block_handler::*;
use crate::fs::block_repr::*;
use alloc::vec::Vec;

pub struct DiskHandler<D: BlockDevice> {
	disk: D,
	sb: SuperBlock,
	ib: InodeBitmap,
	db: DataBitmap,
...
// 	num_blocks: usize,
// 	block_size: usize,
// 	// maybe add some parameter to actually refer to some memory address on disk.img from where the
// 	// blocks
// 	// are given out
// }
//
...
// }
//
// // TODO: Change the BlockDevice implementation here to use disk.img with virtIO later on
...
// }
//
// /// File System interacts with this
// struct DiskHandler {
// 	disk: DiskImage, // provides us raw blocks
// 	sb: SuperBlock,  // operates on those blocks
// }
